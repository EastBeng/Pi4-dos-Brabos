...
base = [('Essa capinha de celular é muito boa', 'alegria'),
        ...
        ('Abaixo do esperado', 'tristeza'),
        ('Não gostei', 'tristeza'),
        ('Desbotou na primeira semana', 'tristeza'),
        ('Olha só essa capinha! ', 'alegria'),
        ('Material de baixa resistência', 'tristeza'),
        ('Custo beneficio excelente', 'alegria'),
        ('A foto é diferente do produto', 'tristeza')]
...
teste = 'Hoje sinceramente eu não estou muito bem para fazer certas coisas'
testestem = []
stemmer = nltk.stem.RSLPStemmer()
